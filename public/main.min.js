...
utils_hooks__hooks.createFromInputFallback=deprecate("value provided is not in a recognized ISO format. moment construction falls back to js Date(), which is not reliable across all browsers and versions. Non ISO date formats are discouraged and will be removed in an upcoming major release. Please refer to http://momentjs.com/guides/#/warnings/js-date/ for more info.",function(config){config._d=new Date(config._i+(config._useUTC?" UTC":""))}),utils_hooks__hooks.ISO_8601=function(){};var prototypeMin=deprecate("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/",function(){var other=local__createLocal.apply(null,arguments);return this.isValid()&&other.isValid()?other<this?this:other:valid__createInvalid()}),prototypeMax=deprecate("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/",function(){var other=local__createLocal.apply(null,arguments);return this.isValid()&&other.isValid()?other>this?this:other:valid__createInvalid()}),now=function(){return Date.now?Date.now():+new Date};offset("Z",":"),offset("ZZ",""),addRegexToken("Z",matchShortOffset),addRegexToken("ZZ",matchShortOffset),addParseToken(["Z","ZZ"],function(input,array,config){config._useUTC=!0,config._tzm=offsetFromString(matchShortOffset,input)});var chunkOffset=/([\+\-]|\d\d)/gi;utils_hooks__hooks.updateOffset=function(){};var aspNetRegex=/^(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/,isoRegex=/^(-)?P(?:(-?[0-9,.]*)Y)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)W)?(?:(-?[0-9,.]*)D)?(?:T(?:(-?[0-9,.]*)H)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)S)?)?$/;create__createDuration.fn=Duration.prototype;var add_subtract__add=createAdder(1,"add"),add_subtract__subtract=createAdder(-1,"subtract");utils_hooks__hooks.defaultFormat="YYYY-MM-DDTHH:mm:ssZ",utils_hooks__hooks.defaultFormatUtc="YYYY-MM-DDTHH:mm:ss[Z]";var lang=deprecate("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.",function(key){return void 0===key?this.localeData():this.locale(key)});addFormatToken(0,["gg",2],0,function(){return this.weekYear()%100}),addFormatToken(0,["GG",2],0,function(){return this.isoWeekYear()%100}),addWeekYearFormatToken("gggg","weekYear"),addWeekYearFormatToken("ggggg","weekYear"),addWeekYearFormatToken("GGGG","isoWeekYear"),addWeekYearFormatToken("GGGGG","isoWeekYear"),addUnitAlias("weekYear","gg"),addUnitAlias("isoWeekYear","GG"),addUnitPriority("weekYear",1),addUnitPriority("isoWeekYear",1),addRegexToken("G",matchSigned),addRegexToken("g",matchSigned),addRegexToken("GG",match1to2,match2),addRegexToken("gg",match1to2,match2),addRegexToken("GGGG",match1to4,match4),addRegexToken("gggg",match1to4,match4),addRegexToken("GGGGG",match1to6,match6),addRegexToken("ggggg",match1to6,match6),addWeekParseToken(["gggg","ggggg","GGGG","GGGGG"],function(input,week,config,token){week[token.substr(0,2)]=toInt(input)}),addWeekParseToken(["gg","GG"],function(input,week,config,token){week[token]=utils_hooks__hooks.parseTwoDigitYear(input)}),addFormatToken("Q",0,"Qo","quarter"),addUnitAlias("quarter","Q"),addUnitPriority("quarter",7),addRegexToken("Q",match1),addParseToken("Q",function(input,array){array[MONTH]=3*(toInt(input)-1)}),addFormatToken("D",["DD",2],"Do","date"),addUnitAlias("date","D"),addUnitPriority("date",9),addRegexToken("D",match1to2),addRegexToken("DD",match1to2,match2),addRegexToken("Do",function(isStrict,locale){return isStrict?locale._ordinalParse:locale._ordinalParseLenient}),addParseToken(["D","DD"],DATE),addParseToken("Do",function(input,array){array[DATE]=toInt(input.match(match1to2)[0],10)});var getSetDayOfMonth=makeGetSet("Date",!0);addFormatToken("DDD",["DDDD",3],"DDDo","dayOfYear"),addUnitAlias("dayOfYear","DDD"),addUnitPriority("dayOfYear",4),addRegexToken("DDD",match1to3),addRegexToken("DDDD",match3),addParseToken(["DDD","DDDD"],function(input,array,config){config._dayOfYear=toInt(input)}),addFormatToken("m",["mm",2],0,"minute"),addUnitAlias("minute","m"),addUnitPriority("minute",14),addRegexToken("m",match1to2),addRegexToken("mm",match1to2,match2),addParseToken(["m","mm"],MINUTE);var getSetMinute=makeGetSet("Minutes",!1);addFormatToken("s",["ss",2],0,"second"),addUnitAlias("second","s"),addUnitPriority("second",15),addRegexToken("s",match1to2),addRegexToken("ss",match1to2,match2),addParseToken(["s","ss"],SECOND);var getSetSecond=makeGetSet("Seconds",!1);addFormatToken("S",0,0,function(){return~~(this.millisecond()/100)}),addFormatToken(0,["SS",2],0,function(){return~~(this.millisecond()/10)}),addFormatToken(0,["SSS",3],0,"millisecond"),addFormatToken(0,["SSSS",4],0,function(){return 10*this.millisecond()}),addFormatToken(0,["SSSSS",5],0,function(){return 100*this.millisecond()}),addFormatToken(0,["SSSSSS",6],0,function(){return 1e3*this.millisecond()}),addFormatToken(0,["SSSSSSS",7],0,function(){return 1e4*this.millisecond()}),addFormatToken(0,["SSSSSSSS",8],0,function(){return 1e5*this.millisecond()}),addFormatToken(0,["SSSSSSSSS",9],0,function(){return 1e6*this.millisecond()}),addUnitAlias("millisecond","ms"),addUnitPriority("millisecond",16),addRegexToken("S",match1to3,match1),addRegexToken("SS",match1to3,match2),addRegexToken("SSS",match1to3,match3);var token;for(token="SSSS";token.length<=9;token+="S")addRegexToken(token,matchUnsigned);for(token="S";token.length<=9;token+="S")addParseToken(token,parseMs);var getSetMillisecond=makeGetSet("Milliseconds",!1);addFormatToken("z",0,0,"zoneAbbr"),addFormatToken("zz",0,0,"zoneName");var momentPrototype__proto=Moment.prototype;momentPrototype__proto.add=add_subtract__add,momentPrototype__proto.calendar=moment_calendar__calendar,momentPrototype__proto.clone=clone,momentPrototype__proto.diff=diff,momentPrototype__proto.endOf=endOf,momentPrototype__proto.format=format,momentPrototype__proto.from=from,momentPrototype__proto.fromNow=fromNow,momentPrototype__proto.to=to,momentPrototype__proto.toNow=toNow,momentPrototype__proto.get=stringGet,momentPrototype__proto.invalidAt=invalidAt,momentPrototype__proto.isAfter=isAfter,momentPrototype__proto.isBefore=isBefore,momentPrototype__proto.isBetween=isBetween,momentPrototype__proto.isSame=isSame,momentPrototype__proto.isSameOrAfter=isSameOrAfter,momentPrototype__proto.isSameOrBefore=isSameOrBefore,momentPrototype__proto.isValid=moment_valid__isValid,momentPrototype__proto.lang=lang,momentPrototype__proto.locale=locale,momentPrototype__proto.localeData=localeData,momentPrototype__proto.max=prototypeMax,momentPrototype__proto.min=prototypeMin,momentPrototype__proto.parsingFlags=parsingFlags,momentPrototype__proto.set=stringSet,momentPrototype__proto.startOf=startOf,momentPrototype__proto.subtract=add_subtract__subtract,momentPrototype__proto.toArray=toArray,momentPrototype__proto.toObject=toObject,momentPrototype__proto.toDate=toDate,momentPrototype__proto.toISOString=moment_format__toISOString,momentPrototype__proto.toJSON=toJSON,momentPrototype__proto.toString=toString,momentPrototype__proto.unix=unix,momentPrototype__proto.valueOf=to_type__valueOf,momentPrototype__proto.creationData=creationData,momentPrototype__proto.year=getSetYear,momentPrototype__proto.isLeapYear=getIsLeapYear,momentPrototype__proto.weekYear=getSetWeekYear,momentPrototype__proto.isoWeekYear=getSetISOWeekYear,momentPrototype__proto.quarter=momentPrototype__proto.quarters=getSetQuarter,momentPrototype__proto.month=getSetMonth,momentPrototype__proto.daysInMonth=getDaysInMonth,momentPrototype__proto.week=momentPrototype__proto.weeks=getSetWeek,momentPrototype__proto.isoWeek=momentPrototype__proto.isoWeeks=getSetISOWeek,momentPrototype__proto.weeksInYear=getWeeksInYear,momentPrototype__proto.isoWeeksInYear=getISOWeeksInYear,momentPrototype__proto.date=getSetDayOfMonth,momentPrototype__proto.day=momentPrototype__proto.days=getSetDayOfWeek,momentPrototype__proto.weekday=getSetLocaleDayOfWeek,momentPrototype__proto.isoWeekday=getSetISODayOfWeek,momentPrototype__proto.dayOfYear=getSetDayOfYear,momentPrototype__proto.hour=momentPrototype__proto.hours=getSetHour,momentPrototype__proto.minute=momentPrototype__proto.minutes=getSetMinute,momentPrototype__proto.second=momentPrototype__proto.seconds=getSetSecond,momentPrototype__proto.millisecond=momentPrototype__proto.milliseconds=getSetMillisecond,momentPrototype__proto.utcOffset=getSetOffset,momentPrototype__proto.utc=setOffsetToUTC,momentPrototype__proto.local=setOffsetToLocal,momentPrototype__proto.parseZone=setOffsetToParsedOffset,momentPrototype__proto.hasAlignedHourOffset=hasAlignedHourOffset,momentPrototype__proto.isDST=isDaylightSavingTime,momentPrototype__proto.isLocal=isLocal,momentPrototype__proto.isUtcOffset=isUtcOffset,momentPrototype__proto.isUtc=isUtc,momentPrototype__proto.isUTC=isUtc,momentPrototype__proto.zoneAbbr=getZoneAbbr,momentPrototype__proto.zoneName=getZoneName,momentPrototype__proto.dates=deprecate("dates accessor is deprecated. Use date instead.",getSetDayOfMonth),momentPrototype__proto.months=deprecate("months accessor is deprecated. Use month instead",getSetMonth),momentPrototype__proto.years=deprecate("years accessor is deprecated. Use year instead",getSetYear),momentPrototype__proto.zone=deprecate("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/",getSetZone),momentPrototype__proto.isDSTShifted=deprecate("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information",isDaylightSavingTimeShifted);var momentPrototype=momentPrototype__proto,prototype__proto=Locale.prototype;prototype__proto.calendar=locale_calendar__calendar,prototype__proto.longDateFormat=longDateFormat,prototype__proto.invalidDate=invalidDate,prototype__proto.ordinal=ordinal,prototype__proto.preparse=preParsePostFormat,prototype__proto.postformat=preParsePostFormat,prototype__proto.relativeTime=relative__relativeTime,prototype__proto.pastFuture=pastFuture,prototype__proto.set=locale_set__set,prototype__proto.months=localeMonths,prototype__proto.monthsShort=localeMonthsShort,prototype__proto.monthsParse=localeMonthsParse,prototype__proto.monthsRegex=monthsRegex,prototype__proto.monthsShortRegex=monthsShortRegex,prototype__proto.week=localeWeek,prototype__proto.firstDayOfYear=localeFirstDayOfYear,prototype__proto.firstDayOfWeek=localeFirstDayOfWeek,prototype__proto.weekdays=localeWeekdays,prototype__proto.weekdaysMin=localeWeekdaysMin,prototype__proto.weekdaysShort=localeWeekdaysShort,prototype__proto.weekdaysParse=localeWeekdaysParse,prototype__proto.weekdaysRegex=weekdaysRegex,prototype__proto.weekdaysShortRegex=weekdaysShortRegex,prototype__proto.weekdaysMinRegex=weekdaysMinRegex,prototype__proto.isPM=localeIsPM,prototype__proto.meridiem=localeMeridiem,locale_locales__getSetGlobalLocale("en",{ordinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(number){var b=number%10,output=1===toInt(number%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th";return number+output}}),utils_hooks__hooks.lang=deprecate("moment.lang is deprecated. Use moment.locale instead.",locale_locales__getSetGlobalLocale),utils_hooks__hooks.langData=deprecate("moment.langData is deprecated. Use moment.localeData instead.",locale_locales__getLocale);var mathAbs=Math.abs,asMilliseconds=makeAs("ms"),asSeconds=makeAs("s"),asMinutes=makeAs("m"),asHours=makeAs("h"),asDays=makeAs("d"),asWeeks=makeAs("w"),asMonths=makeAs("M"),asYears=makeAs("y"),milliseconds=makeGetter("milliseconds"),seconds=makeGetter("seconds"),minutes=makeGetter("minutes"),hours=makeGetter("hours"),days=makeGetter("days"),months=makeGetter("months"),years=makeGetter("years"),round=Math.round,thresholds={s:45,m:45,h:22,d:26,M:11},iso_string__abs=Math.abs,duration_prototype__proto=Duration.prototype;duration_prototype__proto.abs=duration_abs__abs,duration_prototype__proto.add=duration_add_subtract__add,duration_prototype__proto.subtract=duration_add_subtract__subtract,duration_prototype__proto.as=as,duration_prototype__proto.asMilliseconds=asMilliseconds,duration_prototype__proto.asSeconds=asSeconds,duration_prototype__proto.asMinutes=asMinutes,duration_prototype__proto.asHours=asHours,duration_prototype__proto.asDays=asDays,duration_prototype__proto.asWeeks=asWeeks,duration_prototype__proto.asMonths=asMonths,duration_prototype__proto.asYears=asYears,duration_prototype__proto.valueOf=duration_as__valueOf,duration_prototype__proto._bubble=bubble,duration_prototype__proto.get=duration_get__get,duration_prototype__proto.milliseconds=milliseconds,duration_prototype__proto.seconds=seconds,duration_prototype__proto.minutes=minutes,duration_prototype__proto.hours=hours,duration_prototype__proto.days=days,duration_prototype__proto.weeks=weeks,duration_prototype__proto.months=months,duration_prototype__proto.years=years,duration_prototype__proto.humanize=humanize,duration_prototype__proto.toISOString=iso_string__toISOString,duration_prototype__proto.toString=iso_string__toISOString,duration_prototype__proto.toJSON=iso_string__toISOString,duration_prototype__proto.locale=locale,duration_prototype__proto.localeData=localeData,duration_prototype__proto.toIsoString=deprecate("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",iso_string__toISOString),duration_prototype__proto.lang=lang,addFormatToken("X",0,0,"unix"),addFormatToken("x",0,0,"valueOf"),addRegexToken("x",matchSigned),addRegexToken("X",matchTimestamp),addParseToken("X",function(input,array,config){config._d=new Date(1e3*parseFloat(input,10))}),addParseToken("x",function(input,array,config){config._d=new Date(toInt(input))}),utils_hooks__hooks.version="2.15.2",setHookCallback(local__createLocal),utils_hooks__hooks.fn=momentPrototype,utils_hooks__hooks.min=min,utils_hooks__hooks.max=max,utils_hooks__hooks.now=now,utils_hooks__hooks.utc=create_utc__createUTC,utils_hooks__hooks.unix=moment__createUnix,utils_hooks__hooks.months=lists__listMonths,utils_hooks__hooks.isDate=isDate,utils_hooks__hooks.locale=locale_locales__getSetGlobalLocale,utils_hooks__hooks.invalid=valid__createInvalid,utils_hooks__hooks.duration=create__createDuration,utils_hooks__hooks.isMoment=isMoment,utils_hooks__hooks.weekdays=lists__listWeekdays,utils_hooks__hooks.parseZone=moment__createInZone,utils_hooks__hooks.localeData=locale_locales__getLocale,utils_hooks__hooks.isDuration=isDuration,utils_hooks__hooks.monthsShort=lists__listMonthsShort,utils_hooks__hooks.weekdaysMin=lists__listWeekdaysMin,utils_hooks__hooks.defineLocale=defineLocale,utils_hooks__hooks.updateLocale=updateLocale,utils_hooks__hooks.locales=locale_locales__listLocales,utils_hooks__hooks.weekdaysShort=lists__listWeekdaysShort,utils_hooks__hooks.normalizeUnits=normalizeUnits,utils_hooks__hooks.relativeTimeRounding=duration_humanize__getSetRelativeTimeRounding,utils_hooks__hooks.relativeTimeThreshold=duration_humanize__getSetRelativeTimeThreshold,utils_hooks__hooks.calendarFormat=getCalendarFormat,utils_hooks__hooks.prototype=momentPrototype;var _moment=utils_hooks__hooks;return _moment})},{}],11:[function(require,module,exports){require("angular-ui-router"),window.AuthenticationContext=require("adal-angular"),require("adal-angular/lib/adal-angular");var app=angular.module("app.Route",["ui.router"]);app.config(function($stateProvider,$urlRouterProvider,$locationProvider,$httpProvider){$urlRouterProvider.when("","/home/dashboard"),$urlRouterProvider.when("/","/home/dashboard"),$urlRouterProvider.otherwise("/home/dashboard"),$stateProvider.state("home",{abstract:!0,url:"/home",template:"<ui-view/>"}).state("home.about",{url:"/about",templateUrl:"templates/home.html"}).state("home.dashboard",{url:"/dashboard",templateUrl:"templates/dashboard.html",controller:"homeCtrl"}).state("social",{abstract:!0,url:"/social",template:"<ui-view/>"}).state("social.platform",{url:"/:platform",templateUrl:"templates/social.test.html",controller:"socialCtrl"}).state("thirdParty",{abstract:!0,url:"/thirdParty",template:"<ui-view/>"}).state("thirdParty.platform",{url:"/:platform",templateUrl:"templates/social.test.html",controller:"socialCtrl"}).state("msPlatform",{abstract:!0,url:"/msPlatform",template:"<ui-view/>"}).state("msPlatform.platform",{url:"/:platform",templateUrl:"templates/social.test.html",controller:"socialCtrl"}).state("share",{url:"/share",template:"<sub-window></sub-window>"}),$locationProvider.html5Mode(!0).hashPrefix("!")}),module.exports="app.Route"},{"adal-angular":2,"adal-angular/lib/adal-angular":1,"angular-ui-router":7}],12:[function(require,module,exports){module.exports=function($scope,$rootScope,$timeout,$q,$compile){$scope.query={};var sections=8,totalrequests=0;$scope.flags={m:!1,g:!1,r:!1},$("#scrollspy .list .item .label").popup(),$timeout(function(){$scope.flags.g=!0},2e3).then(function(){$timeout(function(){$scope.flags.r=!0},2e3)}),$scope.swapTab=function(platform){$scope.selected=platform,$(".ui.tabular.menu").tab("change tab",platform);var chartDom=$('.ui.tab[data-tab="'+platform+'"]').find("div.echart").get(0);chartDom&&echarts.getInstanceByDom(chartDom).resize()},$scope.isSelected=function(section){return $scope.selected===section},$scope.getTopics=function(){$scope.service.getCate().then(function(data){$scope.topics=data,$rootScope.global.topic&&$scope.startGetData($rootScope.global.topic)})},$scope.getTopics(),$scope.$on("data-got",function(event,arg){$scope.flags.m=!0,$("#progress").progress("increment"),$("#progress").progress("get value")===$scope.totalrequests&&$timeout(function(){$("#progress").hide()},1e3)}),$scope.startGetData=function(topic){$rootScope.global.topic=topic,$scope.flags.m=!1,$("div.echart").map(function(){echarts.getInstanceByDom(this).clear()}),$("#progress").progress("reset"),$("#progress").show(),$scope.query.topic!==topic?($scope.enabledPlatforms=[],$scope.query.topic=topic,$timeout(function(){$scope.topics.forEach(function(item){item.TechCategoryName.toLowerCase()===topic.toLowerCase()&&item.Platforms.forEach(function(p){p.isEnabled&&$scope.enabledPlatforms.push(p.PlatformName)})}),$scope.totalrequests=sections*$scope.enabledPlatforms.length+totalrequests,$("#progress").progress({total:$scope.totalrequests}),$scope.selected=$scope.enabledPlatforms[0]},50)):($scope.$broadcast("start-get-data","home"),$scope.selected=$scope.enabledPlatforms[0])},$scope.finished=function(){$timeout(function(){$scope.$broadcast("start-get-data","home")},50)}}},{}],13:[function(require,module,exports){var app=angular.module("app.Ctrl",[]);app.controller("testCtrl",require("./testCtrl")),app.controller("homeCtrl",require("./homeCtrl")),app.controller("navCtrl",require("./navCtrl")),app.controller("socialCtrl",require("./socialCtrl")),app.controller("scrollCtrl",require("./scrollCtrl")),app.controller("msPlatformCtrl",require("./msPlatformCtrl")),app.controller("thirdPartyCtrl",require("./thirdPartyCtrl")),module.exports="app.Ctrl"},{"./homeCtrl":12,"./msPlatformCtrl":14,"./navCtrl":15,"./scrollCtrl":16,"./socialCtrl":17,"./testCtrl":18,"./thirdPartyCtrl":19}],14:[function(require,module,exports){module.exports=function($scope,$location){}},{}],15:[function(require,module,exports){module.exports=function($scope,$location){}},{}],16:[function(require,module,exports){module.exports=function($scope){$scope.isSmall=!0,$(window).resize(function(){console.log(window.innerWidth),window.innerWidth<1200?$scope.isSmall=!1:$scope.isSmall=!0,console.log($scope.isSmall)})}},{}],17:[function(require,module,exports){module.exports=function($scope,$rootScope,$timeout,$filter,$document,$location){$scope.platform=$scope.$stateParams.platform.toLowerCase(),$scope.order=$filter("orderBy"),$scope.query={},$scope.path=$location.path().split("/");var totalrequests=0;switch($scope.platform){case"twitter":totalrequests=14;break;default:totalrequests=13}$("#progress").progress({total:totalrequests}),$("#server_status").popup({inline:!0,hoverable:!0,position:"bottom left"}),$scope.flags={m:!1,g:!1,r:!1},$(".ui.segment").find(".ui.dropdown").dropdown({onChange:function(value,text,$selectedItem){$scope.topic=value,$scope.startGetData()}}),$("#scrollspy .list .item .label").popup(),$("#topic_select").dimmer("show"),$scope.getTopics=function(){$scope.service.getCate($scope.$stateParams.platform).then(function(data){$scope.topics=[],data.map(function(item){var flage=!1;item.Platforms.map(function(obj){obj.PlatformName.toLowerCase()==$scope.$stateParams.platform&&(flage=obj.isEnabled)}),flage&&$scope.topics.push(item.TechCategoryName)}),$("#topic_select").dimmer("hide"),$scope.topics.indexOf($rootScope.global.topic)!==-1&&($scope.topic=$rootScope.global.topic,$scope.startGetData(),$(".ui.segment").find(".ui.dropdown").dropdown("set text",$rootScope.global.topic))})},$scope.getTopics(),$scope.$on("data-got",function(event,arg){$scope.flags.m=!0,$("#progress").progress("increment"),$("#progress").progress("get value")===totalrequests&&$timeout(function(){$("#progress").hide()},1e3)}),$scope.getMentionedServiceTable=function(platform,topic){$scope.service.getMentionedMostServiceList(platform,topic).then(function(data){$scope.mostMentionedService=data,$scope.$broadcast("data-got")})},$scope.startGetData=function(){return $scope.topic?($rootScope.global.topic=$scope.topic,$scope.flags.m=!1,$("div.echart").map(function(){echarts.getInstanceByDom(this).clear()}),$("#progress").progress("reset"),$("#progress").show(),$scope.query.topic=$scope.topic,$scope.getStatistic($scope.$stateParams.platform,$scope.topic),$scope.getMentionedServiceTable($scope.$stateParams.platform,$scope.topic),void $scope.$broadcast("start-get-data","home")):(alert("Need to select a topic!"),!1)},$scope.getStatistic=function(platform,topic,pnscope,days){$scope.service.getImpactSummary(platform,topic,pnscope,days).then(function(data){var influenceData=data.vocinsights.objectcountthistime;$scope.serviceStatus="gery";var flag_spike=influenceData.detectedspikesvol>0,flag_health=influenceData.positivetotalvol<influenceData.negativetotalvol;console.log(flag_spike,flag_health),flag_spike&&flag_health&&($scope.serviceStatus="red"),(flag_spike||flag_health)&&($scope.serviceStatus="yellow"),flag_spike||flag_health||($scope.serviceStatus="green"),$scope.statistic=data,$scope.$broadcast("data-got")})}}},{}],18:[function(require,module,exports){module.exports=function($scope,$http){function rangeData(num,radix){var radix=radix||10;if(1==parseInt(num))return parseInt(Math.random()*radix);for(var tmp=[],i=0;i<num;i++)tmp.push(parseInt(Math.random()*radix));return tmp}$scope.service.test().then(function(data){},function(err){console.log(err)}),$scope.service.getUser().then(function(data){$scope.topUsers=data.slice(0,5)}),$scope.config={group:"chart-group",series:[{name:"Vol",type:"line",data:rangeData(168,10)}],dataZoom:[{show:!0,realtime:!0,start:55,end:100},{type:"inside",realtime:!0,start:55,end:100}],xAxis:{type:"category",boundaryGap:!1,axisLine:{onZero:!1},data:["2009/7/1 0:00","2009/7/1 1:00","2009/7/1 2:00","2009/7/1 3:00","2009/7/1 4:00","2009/7/1 5:00","2009/7/1 6:00","2009/7/1 7:00","2009/7/1 8:00","2009/7/1 9:00","2009/7/1 10:00","2009/7/1 11:00","2009/7/1 12:00","2009/7/1 13:00","2009/7/1 14:00","2009/7/1 15:00","2009/7/1 16:00","2009/7/1 17:00","2009/7/1 18:00","2009/7/1 19:00","2009/7/1 20:00","2009/7/1 21:00","2009/7/1 22:00","2009/7/1 23:00","2009/7/2 0:00","2009/7/2 1:00","2009/7/2 2:00","2009/7/2 3:00","2009/7/2 4:00","2009/7/2 5:00","2009/7/2 6:00","2009/7/2 7:00","2009/7/2 8:00","2009/7/2 9:00","2009/7/2 10:00","2009/7/2 11:00","2009/7/2 12:00","2009/7/2 13:00","2009/7/2 14:00","2009/7/2 15:00","2009/7/2 16:00","2009/7/2 17:00","2009/7/2 18:00","2009/7/2 19:00","2009/7/2 20:00","2009/7/2 21:00","2009/7/2 22:00","2009/7/2 23:00","2009/7/3 0:00","2009/7/3 1:00","2009/7/3 2:00","2009/7/3 3:00","2009/7/3 4:00","2009/7/3 5:00","2009/7/3 6:00","2009/7/3 7:00","2009/7/3 8:00","2009/7/3 9:00","2009/7/3 10:00","2009/7/3 11:00","2009/7/3 12:00","2009/7/3 13:00","2009/7/3 14:00","2009/7/3 15:00","2009/7/3 16:00","2009/7/3 17:00","2009/7/3 18:00","2009/7/3 19:00","2009/7/3 20:00","2009/7/3 21:00","2009/7/3 22:00","2009/7/3 23:00","2009/7/4 0:00","2009/7/4 1:00","2009/7/4 2:00","2009/7/4 3:00","2009/7/4 4:00","2009/7/4 5:00","2009/7/4 6:00","2009/7/4 7:00","2009/7/4 8:00","2009/7/4 9:00","2009/7/4 10:00","2009/7/4 11:00","2009/7/4 12:00","2009/7/4 13:00","2009/7/4 14:00","2009/7/4 15:00","2009/7/4 16:00","2009/7/4 17:00","2009/7/4 18:00","2009/7/4 19:00","2009/7/4 20:00","2009/7/4 21:00","2009/7/4 22:00","2009/7/4 23:00","2009/7/5 0:00","2009/7/5 1:00","2009/7/5 2:00","2009/7/5 3:00","2009/7/5 4:00","2009/7/5 5:00","2009/7/5 6:00","2009/7/5 7:00","2009/7/5 8:00","2009/7/5 9:00","2009/7/5 10:00","2009/7/5 11:00","2009/7/5 12:00","2009/7/5 13:00","2009/7/5 14:00","2009/7/5 15:00","2009/7/5 16:00","2009/7/5 17:00","2009/7/5 18:00","2009/7/5 19:00","2009/7/5 20:00","2009/7/5 21:00","2009/7/5 22:00","2009/7/5 23:00","2009/7/6 0:00","2009/7/6 1:00","2009/7/6 2:00","2009/7/6 3:00","2009/7/6 4:00","2009/7/6 5:00","2009/7/6 6:00","2009/7/6 7:00","2009/7/6 8:00","2009/7/6 9:00","2009/7/6 10:00","2009/7/6 11:00","2009/7/6 12:00","2009/7/6 13:00","2009/7/6 14:00","2009/7/6 15:00","2009/7/6 16:00","2009/7/6 17:00","2009/7/6 18:00","2009/7/6 19:00","2009/7/6 20:00","2009/7/6 21:00","2009/7/6 22:00","2009/7/6 23:00","2009/7/7 0:00","2009/7/7 1:00","2009/7/7 2:00","2009/7/7 3:00","2009/7/7 4:00","2009/7/7 5:00","2009/7/7 6:00","2009/7/7 7:00","2009/7/7 8:00","2009/7/7 9:00","2009/7/7 10:00","2009/7/7 11:00","2009/7/7 12:00","2009/7/7 13:00","2009/7/7 14:00","2009/7/7 15:00","2009/7/7 16:00","2009/7/7 17:00","2009/7/7 18:00","2009/7/7 19:00","2009/7/7 20:00","2009/7/7 21:00","2009/7/7 22:00","2009/7/7 23:00"]},title:{text:"hello world"}},echarts.connect("chart-group"),$scope.statistic={title:"Users Joined Discussion",volume:3424,comment:"Page Views - POST : NEG",labels:[{append:1,color:"red",icon:1,text:12},{append:0,color:"green",icon:0,text:13}]}}},{}],19:[function(require,module,exports){module.exports=function($scope,$location,$stateParams){}},{}],20:[function(require,module,exports){function initChart(echartObj,chartOpt,groupName){setTimeout(function(){echartObj.resize(),echartObj.setOption(chartOpt),groupName&&(echartObj.group=groupName)},100)}function afterInit(rootscope,scope,echartObj){scope.complete=!0,"getMentionedMostServiceList"!==scope.apiFn&&"getKeywordsMentionedMostMapping"!==scope.apiFn&&setTimeout(function(){echartObj.resize()},150),scope.group&&echarts.connect(scope.group),rootscope.$broadcast("data-got",echartObj)}function customInfluenceData(fnPromise,scope){var influenceSeries=function(raw){var influenceData=raw.map(function(item){return item.vocinfluence.voctotalvol}),influencePOSIData=raw.map(function(item){return item.vocinfluence.positiveinfluencedvol}),influenceNEGData=raw.map(function(item){return item.vocinfluence.negativeinfluencedvol}),seriesData=[];switch(scope.pnscope){case"posi":seriesData=influencePOSIData;break;case"neg":seriesData=influenceNEGData;break;default:seriesData=influenceData}return{xAxis:{data:scope.$root.dateList},series:[{name:"Influence Vol",type:"line",data:seriesData}],title:{text:scope.title||""}}},fn=influenceSeries;return fnPromise.then(function(data){return scope.validData(data),fn(data)})}function customSpikesData(fnPromise,scope){var simpleSeries=function(raw){var seriesData=raw.map(function(item){return item.dailyspikevol});return{xAxis:{data:scope.$root.dateList},series:[{name:"Spikes",type:"bar",data:seriesData}],title:{text:scope.title||""}}},barLineSeries=function(raw){var barData=raw.map(function(item){return item.dailyspikevol}),lineData=raw.map(function(item){return item.dailytotalvol});return{xAxis:{data:scope.$root.dateList},grid:{width:"75%"},yAxis:[{type:"value",name:"Spike",nameTextStyle:{color:"#2ec7c9"}},{type:"value",name:"VoC",nameTextStyle:{color:"#baa7e0"}}],series:[{name:"Spikes",type:"line",data:barData},{name:"VoC",yAxisIndex:1,type:"bar",data:lineData}],title:{text:scope.title||""}}},influenceSeries=function(raw){var influenceData=raw.map(function(item){return item.dailytotalinfluencevol}),influencePOSIData=raw.map(function(item){return item.dailyposiinfluencevol}),influenceNEGData=raw.map(function(item){return item.dailyneginfluencevol}),seriesData=[];switch(scope.pnscope){case"posi":seriesData=influencePOSIData;break;case"neg":seriesData=influenceNEGData;break;default:seriesData=influenceData}return{xAxis:{data:scope.$root.dateList},series:[{name:"Influence Vol",type:"line",data:seriesData}],title:{text:scope.title||""}}},fn=simpleSeries;switch(scope.type){case"barLine":fn=barLineSeries;break;case"influence":fn=influenceSeries}return fnPromise.then(function(data){return scope.validData(data),fn(data)})}function customDistributionData(fnPromise,scope){return fnPromise.then(function(data){return scope.validData(data),{series:[{data:[{value:data.positivetotalvol,name:"POS"},{value:data.neutraltotalvol,name:"NEU"},{value:data.negativetotalvol,name:"NEG"}]}],title:{text:scope.title||""}}})}function customWordCloudData(fnPromise,scope){var pnscope=scope.pnscope;return fnPromise.then(function(data){scope.validData(data);var seriesData=data.map(function(item){var tmp={name:item.attachedobject};switch(pnscope){case"posi":var value=item.vocinfluence.positivetotalvol;break;case"neg":var value=item.vocinfluence.negativetotalvol;break;default:var value=item.vocinfluence.voctotalvol}return tmp.value=value,tmp});return{series:{data:seriesData},title:{text:scope.title||""}}})}function customServicesDistributionData(fnPromise,scope){var propertySelect=scope.propertySelect;return fnPromise.then(function(data){scope.validData(data);var seriesData=data.map(function(item){var tmp={name:item.attachedobject};switch(propertySelect){case"messages":var value=item.vocinfluence.voctotalvol;break;case"users":var value=item.vocinfluence.uniqueusers;break;default:var value=item.vocinfluence.voctotalvol}return tmp.value=value,tmp});seriesData=scope.order(seriesData,"-value");for(var tops=seriesData.slice(0,10),rest=seriesData.slice(10),sum=0,total=0,i=0;i<tops.length;i++)total+=tops[i].value;for(var i=0;i<rest.length;i++)sum+=rest[i].value;if(total+=sum,seriesData.length>11){var other={name:"Others",value:sum};tops.push(other)}return seriesData=tops,scope.$root.$broadcast("set-mentioned-table-data",{data:rest,total:total,association:scope.association}),{series:[{data:seriesData}],toolbox:{feature:{myTool1:{show:!0,title:"Switch to Others List",icon:"path://M432.45,595.444c0,2.177-4.661,6.82-11.305,6.82c-6.475,0-11.306-4.567-11.306-6.82s4.852-6.812,11.306-6.812C427.841,588.632,432.452,593.191,432.45,595.444L432.45,595.444z M421.155,589.876c-3.009,0-5.448,2.495-5.448,5.572s2.439,5.572,5.448,5.572c3.01,0,5.449-2.495,5.449-5.572C426.604,592.371,424.165,589.876,421.155,589.876L421.155,589.876z M421.146,591.891c-1.916,0-3.47,1.589-3.47,3.549c0,1.959,1.554,3.548,3.47,3.548s3.469-1.589,3.469-3.548C424.614,593.479,423.062,591.891,421.146,591.891L421.146,591.891zM421.146,591.891",onclick:function(){scope.swithside()}}},show:!0},title:{text:scope.title||""}}})}function customHoriBarData(scope){return{yAxis:{data:Object.keys(scope.raw)},series:[{name:scope.pnscope+" Vol",type:"bar",data:Object.keys(scope.raw).map(function(key){return scope.raw[key]})}],title:{text:scope.title||""}}}function customHourlyData(fnPromise,key,utility,scope){var seriesData=[],xAxisDate=[];return fnPromise.then(function(data){return scope.validData(data),data.map(function(item){if(xAxisDate.push(utility.timeToString(item.attachedobject.timeslot)),item.attachedobject.isspike)var entity={value:item.vocinfluence[key],symbol:"pin",symbolSize:20,label:{normal:{show:!0}}};else var entity={value:item.vocinfluence[key],symbolSize:4};seriesData.push(entity)}),{series:[{name:"Vol",type:"line",showAllSymbol:!0,data:seriesData}],xAxis:{type:"category",boundaryGap:!1,axisLine:{onZero:!1},data:xAxisDate},title:{text:scope.title||""}}})}function initAxisChartOpt(scope){var opt={title:{textStyle:{
fontSize:13}},tooltip:{trigger:"axis"},toolbox:{show:!1,trigger:"axis",feature:{saveAsImage:{show:!0,title:"Save as Image"}}},xAxis:{type:"category",data:[]},yAxis:[{type:"value",axisLabel:{formatter:"{value}"}}],series:[]};return opt}function initHoriChartOpt(scope){var opt={title:{textStyle:{fontSize:13}},tooltip:{trigger:"axis"},grid:{left:"15%",right:"3%"},toolbox:{show:!1,trigger:"axis",feature:{saveAsImage:{show:!0,title:"Save as Image"}}},xAxis:{type:"value",axisLabel:{formatter:function(value){return scope.thousandsuffix(value,1)}}},yAxis:{type:"category",data:[]},series:[]};return opt}function initPieChartOpt(scope){var opt={title:{textStyle:{fontSize:13}},tooltip:{trigger:"item",formatter:"{b} : {c} ({d}%)"},legend:{show:!0,orient:"horizontal",x:"center",y:"top",data:[]},toolbox:{feature:{myTool1:{show:!0,title:"Switch to Others List",icon:"path://M432.45,595.444c0,2.177-4.661,6.82-11.305,6.82c-6.475,0-11.306-4.567-11.306-6.82s4.852-6.812,11.306-6.812C427.841,588.632,432.452,593.191,432.45,595.444L432.45,595.444z M421.155,589.876c-3.009,0-5.448,2.495-5.448,5.572s2.439,5.572,5.448,5.572c3.01,0,5.449-2.495,5.449-5.572C426.604,592.371,424.165,589.876,421.155,589.876L421.155,589.876z M421.146,591.891c-1.916,0-3.47,1.589-3.47,3.549c0,1.959,1.554,3.548,3.47,3.548s3.469-1.589,3.469-3.548C424.614,593.479,423.062,591.891,421.146,591.891L421.146,591.891zM421.146,591.891",onclick:function(){scope.swithside()}}},show:!0},series:[{name:"Tech Scope Distribution",type:"pie",radius:["35%","55%"],label:{normal:{label:{show:!0},labelLine:{show:!0},formatter:"{b}\n ({d}%)"}},data:[]}]};return opt}function initCloudWordChartOpt(scope){return{title:{textStyle:{fontSize:13},x:"center"},tooltip:{trigger:"item",formatter:"{b} : {c}"},series:{type:"wordCloud",gridSize:1,sizeRange:[12,35],rotationRange:[-90,90],shape:"pentagon",left:"center",top:"center",width:"90%",height:"80%",textStyle:{normal:{color:function(){return"rgb("+[Math.round(160*Math.random()),Math.round(160*Math.random()),Math.round(160*Math.random())].join(",")+")"}},emphasis:{shadowBlur:10,shadowColor:"#333"}},data:[]}}}function initHourlyChartOpt(scope){var opt={title:{textStyle:{fontSize:13}},tooltip:{trigger:"axis",axisPointer:{type:"shadow"}},toolbox:{show:!1,trigger:"axis",feature:{saveAsImage:{show:!0,title:"Save as Image"}}},dataZoom:[{show:!0,realtime:!0,start:0,end:100},{type:"inside",realtime:!0,start:0,end:100}],xAxis:{data:[]},yAxis:{},series:[]};return opt}function isEmpty(obj){if(null==obj)return!0;if(obj.length>0)return!1;if(0===obj.length)return!0;if("object"!=typeof obj)return!0;for(var key in obj)if(hasOwnProperty.call(obj,key))return!1;return!0}var moment=require("moment");module.exports=function($rootScope,$filter,$q,$location,$compile,utilitySrv){return{restrict:"E",templateUrl:"public/template/chart.html",replace:!0,scope:{title:"@",type:"@",platform:"@",pnscope:"@",propertySelect:"@",days:"@",apiFn:"@",subFn:"@",group:"@",query:"=",noPop:"@",association:"@",swithTool:"@"},link:function(scope,element,attrs){var _=scope,echartDom=$(element).find("div.echart");_.service=$rootScope.service,_.complete=!1,_.query=_.query||{},_.compile=function(chart,dom){var el=$compile(chart)(_.$parent);$(dom).append(el)},_.swithside=function(){$(element).parent().parent().parent().shape("flip up")},_.initChartOpt=function(){switch(_.type){case"pie":_.chartOpt=initPieChartOpt(_);break;case"hori":_.chartOpt=initHoriChartOpt(_);break;case"wordcloud":_.chartOpt=initCloudWordChartOpt(_);break;case"hourly":_.chartOpt=initHourlyChartOpt(_);break;default:_.chartOpt=initAxisChartOpt(_)}}(),_.chartObj=echarts.init(echartDom[0],"macarons"),_.chartObj.on("click",function(params){if(0!==params.value)if(void 0===attrs.noPop)switch(_.subFn){case"getVoCDetailsByDate":var param={platform:_.platform,topic:_.query.topic,date:Math.floor(moment.utc(params.name)/1e3),pnscope:_.pnscope};$rootScope.popSubWin({fn:_.subFn,param:param});break;case"getVoCDetailsByPN":var pnscope=params.name.toLowerCase();"pos"==pnscope&&(pnscope="posi");var param={platform:_.platform,topic:_.query.topic,pnscope:pnscope};$rootScope.popSubWin({fn:_.subFn,param:param});break;case"getVoCDetailsByUser":var param={platform:_.platform,topic:_.query.topic,user:params.name,pnscope:_.pnscope};$rootScope.popSubWin({fn:_.subFn,param:param});break;case"getVoCDetailsByServiceName":var param={platform:_.platform,topic:_.query.topic,service:params.name,pnscope:_.pnscope};"Others"===params.name?_.swithside():$rootScope.popSubWin({fn:_.subFn,param:param});break;case"getSubPageVoCDetails":var param={platform:_.platform,topic:_.query.topic,date:Math.floor(moment.utc(params.name)/1e3),pnscope:_.pnscope};$rootScope.popSubWin({fn:_.subFn,param:param});break;case"getSubPageVoCDetailsbyKeywords":var param={platform:_.platform,topic:_.query.topic,keywords:params.name,pnscope:_.pnscope};$rootScope.popSubWin({fn:_.subFn,param:param})}else if(attrs.redirect){var path="/";switch(params.name){case"twitter":path="/social/"+params.name;break;case"so":path="/thirdParty/"+params.name;break;case"sf":path="/thirdParty/"+params.name;break;case"su":path="/thirdParty/"+params.name;break;case"msdn":path="/msPlatform/"+params.name;break;case"tn":path="/msPlatform/"+params.name}scope.$apply(function(){$location.path(path)})}}),_.getData=function(location){if(attrs.location===location){_.complete=!1;var apiFn=_.service[_.apiFn];switch(_.apiFn){case"getSpikes":var fnPromise=apiFn(_.platform,_.query.topic,_.query.days);customSpikesData(fnPromise,_).then(function(config){_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt,_.group),afterInit($rootScope,_,_.chartObj)});break;case"getInfluence":if(_.platform){var fnPromise=apiFn(_.platform,_.query.topic,_.pnscope,_.query.days);customInfluenceData(fnPromise,_).then(function(config){_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt,_.group),afterInit($rootScope,_,_.chartObj)})}else{_.thousandsuffix=$filter("thousandsuffix"),_.platforms=_.$parent.enabledPlatforms,_.raw={},_.platforms.forEach(function(element){_.raw[element]=0},this);var fnPromises=_.platforms.map(function(item){return apiFn(item,_.query.topic,_.pnscope,_.query.days).then(function(data){var seriesData=data.map(function(raw){switch(_.pnscope){case"posi":var value=raw.vocinfluence.positiveinfluencedvol;break;case"neg":var value=raw.vocinfluence.negativeinfluencedvol;break;case"neu":var value=raw.vocinfluence.neutralinfluencedvol;break;case"undif":var value=raw.vocinfluence.undefinedinfluencedvol;break;default:var value=raw.vocinfluence.vocinfluencedvol}return value});_.raw[item]=seriesData.reduce(function(previousValue,currentValue,currentIndex,array){return previousValue+currentValue},0),_.hasData=!0})});$q.all(fnPromises).then(function(){var config=customHoriBarData(_);_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt),afterInit($rootScope,_,_.chartObj)})}break;case"getDistribution":var fnPromise=apiFn(_.platform,_.query.topic);customDistributionData(fnPromise,_).then(function(config){_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt),afterInit($rootScope,_,_.chartObj)});break;case"getMentionedMostServiceList":var fnPromise=apiFn(_.platform,_.query.topic,_.pnscope),fn=customWordCloudData;fn(fnPromise,_).then(function(config){_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt),afterInit($rootScope,_,_.chartObj)});break;case"getMentionedMostServiceListByUserVol":var fnPromise=apiFn(_.platform,_.query.topic,_.pnscope);_.order=$filter("orderBy");var fn=customServicesDistributionData;fn(fnPromise,_).then(function(config){_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt),afterInit($rootScope,_,_.chartObj)});break;case"getMentionedMostServiceDistribution":var fnPromise=apiFn(_.platform,_.query.topic,_.pnscope);_.order=$filter("orderBy"),customServicesDistributionData(fnPromise,_).then(function(config){_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt),afterInit($rootScope,_,_.chartObj)});break;case"getKeywordsMentionedMostMapping":var fnPromise=apiFn(_.platform,_.query.topic,_.pnscope),fn=customWordCloudData;fn(fnPromise,_).then(function(config){_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt),afterInit($rootScope,_,_.chartObj)});break;case"getUserVolSpikes":var fnPromise=apiFn(_.platform,_.query.topic,_.pnscope),fn=customHourlyData;fn(fnPromise,"uniqueusers",utilitySrv,_).then(function(config){_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt,_.group),afterInit($rootScope,_,_.chartObj)});break;case"getMessageVolSpikes":var fnPromise=apiFn(_.platform,_.query.topic,_.pnscope),fn=customHourlyData,key="";switch(_.pnscope){case"posi":key="voctotalvol";break;case"neg":key="voctotalvol";break;default:key="voctotalvol"}fn(fnPromise,key,utilitySrv,_).then(function(config){_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt,_.group),afterInit($rootScope,_,_.chartObj)});break;case"getInfluenceVolSpikes":var fnPromise=apiFn(_.platform,_.query.topic,_.pnscope),fn=customHourlyData;fn(fnPromise,"vocinfluencedvol",utilitySrv,_).then(function(config){_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt,_.group),afterInit($rootScope,_,_.chartObj)});break;case"getUserRegionVolSpikes":var fnPromise=apiFn(_.platform,_.query.topic,_.pnscope),fn=customHourlyData;fn(fnPromise,"uniqueuserregion",utilitySrv,_).then(function(config){_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt,_.group),afterInit($rootScope,_,_.chartObj)})}}},_.$on("start-get-data",function(event,arg){_.complete=!1,_.getData(arg)}),_.$on("fresh-most-mentioned",function(evt,arg){if(("getMentionedMostServiceList"===_.apiFn||"getMentionedMostServiceListByUserVol"===_.apiFn)&&"home"===attrs.location){var apiFn=_.service[_.apiFn];if(arg.pnscope===_.pnscope){_.platform=arg.platform?arg.platform:_.platform,_.pnscope=arg.pnscope?arg.pnscope:_.pnscope,_.topic=arg.topic?arg.topic:_.topic;var fnPromise=apiFn(_.platform,_.query.topic,_.pnscope),fn=customWordCloudData;_.chartOpt=initCloudWordChartOpt(_),fn(fnPromise,_).then(function(config){_.chartOpt=angular.merge(_.chartOpt,config);var clientWidth=element.parents(".sides").width();element.find(".echart").width(clientWidth),_.chartObj.setOption(_.chartOpt)})}}}),_.$on("set-sub-widows-charts-data",function(evt,arg){if("sub"===attrs.location){var config={};switch(_.type){case"pie":var raw=arg.data;_.validData(raw),config={series:[{data:[{value:raw.vocpositivecount,name:"POS"},{value:raw.vocneutralcount,name:"NEU"},{value:raw.vocnegativecount,name:"NEG"}]}],title:{text:_.title||""}};break;case"wordcloud":var raw=arg.data.vocmentionedmost;_.validData(raw);var seriesData=raw.map(function(item){var tmp={name:item.attachedobject};switch(_.pnscope){case"posi":var value=item.vocinfluence.positivetotalvol;break;case"neg":var value=item.vocinfluence.negativetotalvol;break;default:var value=item.vocinfluence.voctotalvol}return tmp.value=value,tmp});config={series:{data:seriesData},title:{text:_.title||""}}}_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt),_.complete=!0}}),_.validData=function(data){_.hasData=!isEmpty(data)},_.clientWidth=element[0].clientWidth,_.$watch("clientWidth",function(newV,oldV){newV!==oldV&&echarts.getInstanceByDom(echartDom.get(0)).resize()}),$(window).resize(function(){_.$apply(function(){_.clientWidth=element[0].clientWidth})})}}}},{moment:10}],21:[function(require,module,exports){function initChart(echartObj,chartOpt){setTimeout(function(){echartObj.resize(),echartObj.setOption(chartOpt)},100)}function afterInit(rootscope,scope,echartObj){scope.complete=!0,setTimeout(function(){echartObj.resize()},150),rootscope.$broadcast("data-got",echartObj)}function customRadarData(fnPromise,scope){var dataSeries=function(raw){var numberic=scope.filter("number"),joinedusers=raw.joinedusers.comparedratio||0,influenceofusers=raw.influenceofusers.comparedratio||0,mentionedservicecount=raw.mentionedservicecount.comparedratio||0,mostpost=raw.vocinsights.comparedratio||0,positivepost=(raw.vocinsights.objectcountthistime.positivetotalvol-raw.vocinsights.objectcountlasttime.positivetotalvol)/(raw.vocinsights.objectcountlasttime.positivetotalvol||1)||0,negativepost=(raw.vocinsights.objectcountthistime.negativetotalvol-raw.vocinsights.objectcountlasttime.negativetotalvol)/(raw.vocinsights.objectcountlasttime.negativetotalvol||1)||0;scope.listData=[joinedusers,influenceofusers,mentionedservicecount,mostpost,positivepost,negativepost];for(var dataArray=[numberic(1+joinedusers),numberic(1+influenceofusers),numberic(1+mentionedservicecount),numberic(1+mostpost),numberic(1+positivepost),numberic(1+negativepost)],i=0;i<dataArray.length;i++)dataArray[i]>2&&(dataArray[i]=2),dataArray[i]<0&&(dataArray[i]=0);return{series:[{type:"radar",data:[{value:dataArray,name:scope.platform+" - Status"}]}],title:{text:scope.title||""}}},fn=dataSeries;return fnPromise.then(function(data){return!!scope.validData(data)&&fn(data)})}function initRadarChartOpt(scope){var opt={tooltip:{formatter:function(params){var res=[];return params.value.forEach(function(cur,index){res.push(scope.labels[index]+" : "+scope.filter("percentage")(cur-1,3,!0))}),res.join("<br />")}},radar:{indicator:scope.labels.map(function(item){return{name:item,max:2}})}};return opt}function isEmpty(obj){if(null==obj)return!0;if(obj.length>0)return!1;if(0===obj.length)return!0;if("object"!=typeof obj)return!0;for(var key in obj)if(hasOwnProperty.call(obj,key))return!1;return!0}module.exports=function($rootScope,$filter,$q,$location,$compile,utilitySrv){return{restrict:"E",templateUrl:"public/template/radarchart.html",replace:!0,scope:{title:"@",platform:"@",query:"="},link:function(scope,element,attrs){var _=scope,echartDom=$(element).find("div.echart");_.labels=["User Joined Discussion","Service Mentioned","Influence Impact","Message Post","Postive Post","Negative Post"],_.listData=[],_.service=$rootScope.service,_.complete=!1,_.query=_.query||{},_.filter=$filter,_.chartOpt=initRadarChartOpt(_),_.chartObj=echarts.init(echartDom[0],"macarons"),_.getData=function(location){if(attrs.location===location){_.complete=!1;var apiFn=_.service.getImpactSummary,fnPromise=apiFn(_.platform,_.query.topic);customRadarData(fnPromise,_).then(function(config){_.chartOpt=angular.merge(_.chartOpt,config),initChart(_.chartObj,_.chartOpt,_.group),afterInit($rootScope,_,_.chartObj)})}},_.validData=function(data){var length=Object.keys(data).length,noDataLen=0;for(var key in data)noDataLen+=isEmpty(data[key])?1:0;return noDataLen!==length&&(_.hasData=!0,!0)},_.$on("start-get-data",function(event,arg){_.complete=!1,_.getData(arg)}),_.clientWidth=element[0].clientWidth,_.$watch("clientWidth",function(newV,oldV){newV!==oldV&&echarts.getInstanceByDom(echartDom.get(0)).resize()}),$(window).resize(function(){_.$apply(function(){_.clientWidth=element[0].clientWidth})})}}}},{}],22:[function(require,module,exports){module.exports=function($rootScope){return{restrict:"A",scope:!1,link:function(scope,e,a){function resizeChart(){var dom=e.find(".side.active").find(".echart");dom.get(0)||(dom=e.find(".side.active").siblings(),dom=$(dom[0]).find(".echart")),dom.length&&echarts.getInstanceByDom(dom.get(0)).resize()}function callMentionedService(){"true"===a.linkage&&$rootScope.$broadcast("fresh-most-mentioned",{platform:scope.category,pnscope:a.pnscope})}var id=a.id,lastTime=new Date;scope.category="twitter",$("#"+id+" .ui.dropdown").dropdown({onChange:function(value,text,$selectedItem){scope.category=value;var selector="div.side[page='"+value+"']";e.find("div.shape").shape("set next side",selector).shape("flip up");var dom=e.find(selector).find(".echart");callMentionedService(),echarts.getInstanceByDom(dom.get(0)).resize()}});var leftButton=angular.element(e.find(".ui.left.icon.button")[0]),rightButton=angular.element(e.find(".ui.right.icon.button")[0]),flipLeft=(angular.element(e.find("input:hidden")),function(){var current=new Date;if(current.getTime()-lastTime.getTime()<1e3)return!1;lastTime=current,$(e.find("div.shape").get(0)).shape({onChange:function(){resizeChart()}}).shape("flip left");var cate=e.find("div.side.active").next().attr("page");if(!cate){var dom=e.find(".side.active").siblings();cate=$(dom[0]).attr("page")}scope.category=cate,$("#"+id+" .ui.dropdown").dropdown("set text",cate),callMentionedService()}),flipRight=function(){var current=new Date;if(current.getTime()-lastTime.getTime()<1e3)return!1;lastTime=current,e.find("div.shape").shape({onChange:function(){resizeChart()}}).shape("flip right");var cate=e.find("div.side.active").next().attr("page");if(!cate){var dom=e.find(".side.active").siblings();cate=$(dom[0]).attr("page")}scope.category=cate,$("#"+id+" .ui.dropdown").dropdown("set text",cate),callMentionedService()};leftButton.bind("click",function(e){e.stopPropagation(),flipLeft()}),rightButton.bind("click",function(e){e.stopPropagation(),flipRight()})}}}},{}],23:[function(require,module,exports){var app=angular.module("app.Directive",[]);app.directive("ngEchart",require("./chartDirective")),app.directive("ngRadarEchart",require("./chartRadarDirective")),app.directive("ngStatistic",require("./statisticDirective")),app.directive("ngStatisticLabel",require("./statisticLabelDirective")),app.directive("ngScrollSpy",require("./scrollspyDirective")),app.directive("ngChartShape",require("./chartShapeDirective")),app.directive("userList",require("./userListDirective")),app.directive("subWindow",require("./subWindowDirective")),app.directive("topicQuery",require("./topicQueryDirective")),app.directive("selectPage",require("./selectPageDirective")),app.directive("mentionedTable",require("./mentionedTableDirective")),module.exports="app.Directive"},{"./chartDirective":20,"./chartRadarDirective":21,"./chartShapeDirective":22,"./mentionedTableDirective":24,"./scrollspyDirective":25,"./selectPageDirective":26,"./statisticDirective":27,"./statisticLabelDirective":28,"./subWindowDirective":29,"./topicQueryDirective":30,"./userListDirective":31}],24:[function(require,module,exports){module.exports=function($rootScope,$compile){return{restrict:"E",templateUrl:"public/template/mentioned_table.html",replace:!0,scope:{platform:"@",query:"=",association:"@"},link:function(scope,e,a){$rootScope.$on("set-mentioned-table-data",function(evt,arg){scope.association===arg.association&&(scope.total=arg.total,scope.mostMentionedService=arg.data)}),scope.popDetail=function(serverName){var param={platform:scope.platform,topic:scope.query.topic,service:serverName};$rootScope.popSubWin({fn:"getVoCDetailsByServiceName",param:param})},scope.swithside=function(){$(e).parent().parent().parent().shape("flip up")},scope.getters={twitterInf:function(value){return value.user.followers_count+value.user.friends_count}}}}}},{}],25:[function(require,module,exports){module.exports=function(){return{restrict:"A",link:function(scope,e,a){scope.isSmall=window.innerWidth<1510?1:0,$(window).resize(function(){scope.$apply(function(){window.innerWidth<1510?scope.isSmall=1:scope.isSmall=0})})}}}},{}],26:[function(require,module,exports){module.exports=function(){return{restrict:"E",template:'<div class="ui input mini"><input class="select-page" type="text" ng-model="inputPage" ng-change="selectPage(inputPage)"></div>',link:function(scope,element,attrs){scope.$watch("currentPage",function(c){scope.inputPage=c})}}}},{}],27:[function(require,module,exports){var label_type={compared:"Compared with Last Week",spike:"Vol Spike Detected (hourly)",string:""};module.exports=function($parse,$filter){return{restrict:"E",templateUrl:"public/template/statistic.html",replace:!0,scope:{data:"=",title:"@",comment:"@",color:"@"},link:function(scope,e,a){var numberFormat=$filter("thousandsuffix");$filter("percentage");switch(scope.volume=scope.data.volume,scope.comment&&(scope.comment=scope.data.comment,$($(e).find(".popup").get(0)).popup()),a.type){case"joinedusers":scope.volume=numberFormat(scope.data.objectcountthistime),scope.labels=[{text:label_type.compared,volume:scope.data.comparedratio,type:"ratio",isCompared:!0},{text:label_type.spike,volume:scope.data.detectedhourlyspikesvol,color:"red"}];break;case"regionofusers":scope.volume=numberFormat(scope.data.objectcountthistime),scope.volume=0===scope.volume?"No Data Available":scope.volume,"twitter"!==scope.$parent.$parent.platform.toLowerCase()?scope.labels=[]:scope.labels=[{text:label_type.compared,volume:scope.data.comparedratio,type:"ratio",isCompared:!0},{text:label_type.spike,volume:scope.data.detectedhourlyspikesvol,color:"red"}];break;case"influenceofusers":scope.volume=numberFormat(scope.data.objectcountthistime),scope.labels=[{text:label_type.compared,volume:scope.data.comparedratio,type:"ratio",isCompared:!0},{text:label_type.spike,volume:scope.data.detectedhourlyspikesvol,color:"red"}];break;case"mentionedservicecount":scope.volume=numberFormat(scope.data.objectcountthistime),scope.labels=[{text:label_type.compared,volume:scope.data.comparedratio,type:"ratio",isCompared:!0},{text:label_type.spike,volume:scope.data.detectedhourlyspikesvol,color:"red"}];break;case"mostmentionedservice":scope.volume=scope.data[0].mentionedmostservice.attachedobject;var tmp=scope.data.map(function(item){return item.mentionedmostservice.attachedobject+"("+item.occupyratio+"%)"});scope.labels=[{text:tmp.join(",")}];break;case"mostlikedservice":scope.volume=scope.data.mostlikedservice[0].mentionedmostservice.attachedobject+":"+scope.data.mostdislikedservice[0].mentionedmostservice.attachedobject,scope.style={"font-size":"26px"},scope.labels=[{text:scope.data.mostlikedservice.map(function(item){return item.mentionedmostservice.attachedobject+"("+item.occupyratio+"%)"}).join(","),color:"green"},{text:scope.data.mostdislikedservice.map(function(item){return item.mentionedmostservice.attachedobject+"("+item.occupyratio+"%)"}).join(","),color:"red"}];break;case"vocinsightsVol":scope.volume=numberFormat(scope.data.objectcountthistime.voctotalvol),scope.labels=[{text:label_type.compared,volume:scope.data.comparedratio,type:"ratio",isCompared:!0},{text:label_type.spike,volume:scope.data.detectedhourlyspikesvol,color:"red"}];break;case"vocinsightsPN":var originBoj=scope.data.objectcountthistime;scope.volume=[numberFormat(originBoj.positivetotalvol,0),numberFormat(originBoj.negativetotalvol,0),numberFormat(originBoj.neutraltotalvol,0)],scope.subVolume=[originBoj.positivetotalvol/originBoj.voctotalvol,originBoj.negativetotalvol/originBoj.voctotalvol,originBoj.neutraltotalvol/originBoj.voctotalvol],scope.labels=[{text:"POS "+label_type.spike,volume:originBoj.detectedposispikesvol,color:"green"},{text:"NEG "+label_type.spike,volume:originBoj.detectednegspikesvol,color:"red"}];break;case"mostposifrom":var originBoj=scope.data.objectcountthistime;scope.volume=[numberFormat(originBoj.positiveinfluencedvol,0),numberFormat(originBoj.negativeinfluencedvol,0)],scope.subVolume=[originBoj.positiveinfluencedvol/originBoj.vocinfluencedvol,originBoj.negativeinfluencedvol/originBoj.vocinfluencedvol],scope.labels=[]}scope.isVolObj=function(){return angular.isArray(scope.volume)||angular.isObject(scope.volume)}}}}},{}],28:[function(require,module,exports){module.exports=function(){return{restrict:"E",templateUrl:"public/template/statistic_label.html",replace:!0,scope:{},link:function(scope,e,a){scope.label=scope.$parent.label||{},scope.style=scope.label.style||"",scope.volume=isNaN(Number(scope.label.volume))?null:Number(scope.label.volume),scope.text=scope.label.text||"",scope.color=scope.label.color||"black",scope.type=scope.label.type||"",scope.isCompared=scope.label.isCompared||"",scope.getColor=function(){return null===scope.volume?scope.color:""}}}}},{}],29:[function(require,module,exports){function initHourlyChartData(raw,utility){var seriesData=[],xAxisDate=[];raw.map(function(item){if(xAxisDate.push(utility.timeToString(item.attachedobject)),item.vocinfluence.detectedspikesvol)var entity={value:item.vocinfluence.voctotalvol,symbol:"pin",symbolSize:20,label:{normal:{show:!0}}};else var entity={value:item.vocinfluence.voctotalvol,symbolSize:4};seriesData.push(entity)});var title="Hourly Volume Trend",opt={title:{text:title,textStyle:{fontSize:12},x:"center"},tooltip:{trigger:"axis",axisPointer:{type:"shadow"}},dataZoom:[{show:!0,realtime:!0,start:0,end:100},{type:"inside",realtime:!0,start:0,end:100}],xAxis:{type:"category",boundaryGap:!1,axisLine:{onZero:!1},data:xAxisDate},yAxis:{},series:[{name:"Vol",type:"line",showAllSymbol:!0,data:seriesData}]};return opt}module.exports=function($rootScope,$compile,$filter,utilitySrv){return{restrict:"E",templateUrl:"public/template/sub_window.html",replace:!0,scope:{title:"@",platform:"@",query:"="},link:function(scope,e,a){scope.myChart=echarts.init($(e).find(".hourly-charts").get(0)),scope.getData=function(params){scope.platform=params.param.platform.toLowerCase();var fnPromise,fn=$rootScope.service[params.fn];switch(params.fn){case"getVoCDetailsByDate":fnPromise=fn(params.param.platform,params.param.topic,params.param.date,params.param.pnscope,params.param.days);break;case"getVoCDetailsByPN":fnPromise=fn(params.param.platform,params.param.topic,params.param.pnscope,params.param.days);break;case"getVoCDetailsByServiceName":fnPromise=fn(params.param.platform,params.param.topic,params.param.service,params.param.pnscope,params.param.days);break;case"getVoCDetailsByUser":fnPromise=fn(params.param.platform,params.param.topic,params.param.userid,params.param.index,params.param.pnscope,params.param.days);break;case"getSubPageVoCDetails":fnPromise=fn(params.param.platform,params.param.topic,params.param.date,params.param.pnscope,params.param.days);break;case"getSubPageVoCDetailsbyKeywords":fnPromise=fn(params.param.platform,params.param.topic,params.param.keywords,params.param.pnscope,params.param.IsFuzzyQuery,params.param.days)}fnPromise.then(function(data){scope.raw=data,scope.tabledata=data.messagesorthreads,scope.$broadcast("set-user-data",data.topusers),scope.$broadcast("set-sub-widows-charts-data",{data:data}),scope.chartOpt=initHourlyChartData(data.volhourlylist,utilitySrv),scope.myChart.setOption(scope.chartOpt),scope.myChart.resize(),scope.complete=!0})},scope.$on("start-get-data-in-window",function(event,arg){scope.raw=[],scope.tabledata=[],scope.chartOpt={},scope.$broadcast("set-user-data",[]),scope.getData(arg),scope.complete=!1}),scope.getters={twitterInf:function(value){return value.user.followers_count+value.user.friends_count}},scope.swithside=function(){$("#shape-pup").shape("flip up")}}}}},{}],30:[function(require,module,exports){module.exports=function(){return{restrict:"EA",templateUrl:"public/template/topicQuery.html",replace:!0,link:function(scope,e,a){scope.isSmall=window.innerWidth<1510?1:0,$(window).resize(function(){scope.$apply(function(){window.innerWidth<1510?scope.isSmall=1:scope.isSmall=0})})}}}},{}],31:[function(require,module,exports){module.exports=function($rootScope){return{restrict:"E",templateUrl:"public/template/user_list.html",replace:!0,scope:{title:"@",platform:"@",query:"=",pnscope:"@",noPop:"@"},link:function(scope,e,a){scope.pnscope=scope.pnscope||"all",console.log(scope.platform),scope.getAvatorUrl=function(user){return user.attachedobject.profile_image||user.attachedobject.profile_image_url||"public/images/"+scope.platform.toLowerCase()+".png"},scope.onClick=function(user,index){if(void 0===a.noPop){var param={platform:scope.platform,topic:scope.query.topic,userid:user.attachedobject.userId||user.attachedobject.user_id||user.attachedobject.id_str,index:index,pnscope:scope.pnscope};$rootScope.popSubWin({fn:"getVoCDetailsByUser",param:param})}},scope.getData=function(location,force){a.location===location&&$rootScope.service.getUser(scope.platform,5,scope.query.topic,scope.pnscope).then(function(data){scope.users=data.slice(0,5),scope.complete=!0,$rootScope.$broadcast("data-got")})},scope.$on("start-get-data",function(event,arg){scope.complete=!1,scope.getData(arg)}),scope.$on("set-user-data",function(event,arg){"sub"==a.location&&(scope.users=arg,scope.complete=!0)})}}}},{}],32:[function(require,module,exports){var app=angular.module("app.Filter",["app.Srv"]);app.filter("percentage",["$window",function($window){return function(input,decimals,notAbsolute,suffix){var decimals=angular.isNumber(decimals)?decimals:3,suffix=suffix||"%";return $window.isNaN(input)?"":(notAbsolute||(input=Math.abs(input)),Math.round(input*Math.pow(10,decimals+2))/Math.pow(10,decimals)+suffix)}}]),app.filter("sentimentScore",["$window",function($window){var dict={"-1":"Undefined",0:"Negative",2:"Neutral",4:"Positive"};return function(input){return dict[input.toString()]}}]),app.filter("timetostring",["utilitySrv",function(utilitySrv){return function(input){return utilitySrv.timeToString(input)}}]),app.filter("thousandsuffix",["$window",function($window){return function(input,decimals){var exp,decimals=angular.isNumber(decimals)?decimals:2,suffixes=["k","M","G","T","P","E"];return $window.isNaN(input)?input:input<1e3?input:(exp=Math.floor(Math.log(input)/Math.log(1e3)),(input/Math.pow(1e3,exp)).toFixed(decimals)+suffixes[exp-1])}}]),module.exports="app.Filter"},{}],33:[function(require,module,exports){var app=angular.module("app.Srv",[]);app.constant("config",{service:"/DataService/S3PDataService.svc/",dev_service:"/data/"}),app.factory("utilitySrv",require("./utility")),app.factory("baseSrv",function($http,$q,$httpParamSerializer,config){return{get:function(api,params){var path="",qs=params?"?"+$httpParamSerializer(params):"";path=config.service+api+qs;var deferred=$q.defer();return $http.get(path).then(function(data){200==data.status?deferred.resolve(data.data):(console.log(data),deferred.reject(data))},function(err){deferred.reject(err)}),deferred.promise},devGet:function(api,params){var path="",qs=params?"?"+$httpParamSerializer(params):"";path=config.dev_service+api+".json"+qs;var deferred=$q.defer();return $http.get(path).then(function(data){200==data.status&&deferred.resolve(data.data)},function(err){deferred.reject(err)}),deferred.promise}}}),app.factory("testSrv",function(baseSrv){return{test:function(params){return baseSrv.devGet("GetMentionedServiceList")},getCate:function(platform){var params=params||{};return params.platform=platform||"all",baseSrv.devGet("GetAllEnabledTopicsByPlatform",params)},getUser:function(platform,topNum,topic,PNScope){var params=params||{};return params.platform=platform||"all",params.topNum=topNum||5,params.topic=topic||"all",params.PNScope=PNScope||"all",baseSrv.devGet("GetTopUsers",params)},getSpikes:function(platform,topic,days){var params=params||{};return params.platform=platform||"all",params.days=days||7,params.topic=topic||"all",baseSrv.devGet("GetDailyVolSpikes",params)},getDistribution:function(platform,topic){var params=params||{};return params.platform=platform||"all",params.topic=topic||"all",baseSrv.devGet("GetPNDistribution",params)},getMentionedMostServiceList:function(platform,topic,PNScope){var params=params||{};return params.platform=platform||"all",params.topic=topic||"all",params.PNScope=PNScope||"all",baseSrv.devGet("GetMentionedMostServiceList",params)},getMentionedMostServiceListByUserVol:function(platform,topic,PNScope){var params=params||{};return params.platform=platform||"all",params.topic=topic||"all",params.PNScope=PNScope||"all",baseSrv.devGet("GetMentionedMostServiceListByUserVol",params)},getMentionedMostServiceDistribution:function(platform,topic,PNScope){var params=params||{};return params.platform=platform||"all",params.topic=topic||"all",params.PNScope=PNScope||"all",baseSrv.devGet("GetMentionedMostServiceList",params)},getInfluence:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"all",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,
baseSrv.devGet("GetDailyInfluence",params)},getVoCDetailsByDate:function(platform,topic,date,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.date=date||Math.floor((new Date).getTime()/1e3),params.PNScope=PNScope||"all",params.days=days||7,baseSrv.devGet("subwindow",params)},getVoCDetailsByUser:function(platform,topic,user,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.user=user||1234,params.PNScope=PNScope||"all",params.days=days||7,baseSrv.devGet("subwindow."+params.platform,params)},getVoCDetailsByPN:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.devGet("subwindow."+params.platform,params)},getVoCDetailsByServiceName:function(platform,topic,service,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.servicename=service||"webapp",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.devGet("subwindow."+params.platform,params)},getImpactSummary:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.devGet("GetImpactSummary",params)},getUserVolSpikes:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.devGet("GetUserVolSpikes",params)},getMessageVolSpikes:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.devGet("GetMessageVolSpikes",params)},getInfluenceVolSpikes:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.devGet("GetInfluenceVolSpikes",params)},getUserRegionVolSpikes:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.devGet("GetUserRegionVolSpikes",params)},getKeywordsMentionedMostMapping:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.devGet("GetKeywordsMentionedMostMapping",params)},getSubPageVoCDetails:function(platform,topic,date,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.date=date||Math.floor((new Date).getTime()/1e3),params.PNScope=PNScope||"all",params.days=days||7,baseSrv.devGet("subwindow."+params.platform,params)},getSubPageVoCDetailsbyKeywords:function(platform,topic,keywords,PNScope,IsFuzzyQuery,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.keywords=keywords||"notworking",params.PNScope=PNScope||"all",params.IsFuzzyQuery=IsFuzzyQuery||"true",params.days=days||7,baseSrv.devGet("subwindow."+params.platform,params)}}}),app.factory("rawdataSrv",function(baseSrv){return{getCate:function(platform){var params=params||{};return params.platform=platform||"all",baseSrv.get("GetAllEnabledTopicsByPlatform",params)},getUser:function(platform,topNum,topic,PNScope){var params=params||{};return params.platform=platform||"all",params.topNum=topNum||5,params.topic=topic||"all",params.PNScope=PNScope||"all",baseSrv.get("GetTopUsers",params)},getSpikes:function(platform,topic,days){var params=params||{};return params.platform=platform||"all",params.days=days||7,params.topic=topic||"all",baseSrv.get("GetDailyVolSpikes",params)},getDistribution:function(platform,topic){var params=params||{};return params.platform=platform||"all",params.topic=topic||"all",baseSrv.get("GetPNDistribution",params)},getMentionedMostServiceList:function(platform,topic,PNScope){var params=params||{};return params.platform=platform||"all",params.topic=topic||"all",params.PNScope=PNScope||"all",baseSrv.get("GetMentionedMostServiceList",params)},getMentionedMostServiceListByUserVol:function(platform,topic,PNScope){var params=params||{};return params.platform=platform||"all",params.topic=topic||"all",params.PNScope=PNScope||"all",baseSrv.get("GetMentionedMostServiceListByUserVol",params)},getMentionedMostServiceDistribution:function(platform,topic,PNScope){var params=params||{};return params.platform=platform||"all",params.topic=topic||"all",params.PNScope=PNScope||"all",baseSrv.get("GetMentionedMostServiceList",params)},getInfluence:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"all",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.get("GetDailyInfluence",params)},getVoCDetailsByDate:function(platform,topic,date,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.date=date||Math.floor((new Date).getTime()/1e3),params.PNScope=PNScope||"all",params.days=days||7,baseSrv.get("GetVoCDetailsByDate",params)},getVoCDetailsByUser:function(platform,topic,user,index,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.userid=user||1234,params.index=void 0!==index?index:-1,params.PNScope=PNScope||"all",params.days=days||7,baseSrv.get("GetVoCDetailsByUser",params)},getVoCDetailsByPN:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.get("GetVoCDetailsByPN",params)},getVoCDetailsByServiceName:function(platform,topic,service,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.servicename=service||"webapp",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.get("GetVoCDetailsByServiceName",params)},getImpactSummary:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.get("GetImpactSummary",params)},getUserVolSpikes:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.get("GetUserVolSpikes",params)},getMessageVolSpikes:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.get("GetMessageVolSpikes",params)},getInfluenceVolSpikes:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.get("GetInfluenceVolSpikes",params)},getUserRegionVolSpikes:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.get("GetUserRegionVolSpikes",params)},getKeywordsMentionedMostMapping:function(platform,topic,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.PNScope=PNScope||"all",params.days=days||7,baseSrv.get("GetKeywordsMentionedMostMapping",params)},getSubPageVoCDetails:function(platform,topic,date,PNScope,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.Date=date||Math.floor((new Date).getTime()/1e3),params.PNScope=PNScope||"all",params.days=days||7,baseSrv.get("GetSubPageVoCDetails",params)},getSubPageVoCDetailsbyKeywords:function(platform,topic,keywords,PNScope,IsFuzzyQuery,days){var params=params||{};return params.platform=platform||"twitter",params.topic=topic||"all",params.keywords=keywords||"notworking",params.PNScope=PNScope||"all",params.IsFuzzyQuery=IsFuzzyQuery||"false",params.days=days||7,baseSrv.get("GetSubPageVoCDetailsbyKeywords",params)}}}),module.exports="app.Srv"},{"./utility":34}],34:[function(require,module,exports){module.exports=function($filter){return Date.prototype.format=function(format){var o={"M+":this.getUTCMonth()+1,"d+":this.getUTCDate(),"h+":this.getUTCHours(),"m+":this.getUTCMinutes(),"s+":this.getUTCSeconds(),"q+":Math.floor((this.getUTCMonth()+3)/3),S:this.getUTCMilliseconds()};(/(y+)/.test(format)||/(Y+)/.test(format))&&(format=format.replace(RegExp.$1,(this.getUTCFullYear()+"").substr(4-RegExp.$1.length)));for(var k in o)new RegExp("("+k+")").test(format)&&(format=format.replace(RegExp.$1,1==RegExp.$1.length?o[k]:("00"+o[k]).substr((""+o[k]).length)));return format},{toPercent:function(data,decimal){return parseFloat(parseFloat(100*data).toFixed(decimal))},getLastXMonthDate:function(x){var m=new Date;return m.setDate(1),m.setUTCMonth(m.getUTCMonth()-parseInt(x)-1),m.getUTCFullYear()+"/"+(m.getUTCMonth()+1)+"/"+m.getUTCDate()},getTimeRange:function(startDate,endDate,interval,needFormat,format){interval=interval||1,needFormat=needFormat||!0,format=format||"yyyy-MM-dd";for(var retVal=[],current=new Date(startDate);current<=endDate;)retVal.push(new Date(current)),current=function(d){return d.setDate(d.getDate()+interval),d.setHours(0,0,0,0)}(new Date(current));return needFormat&&(retVal=retVal.map(function(date){return $filter("date")(new Date(date),"yyyy-MM-dd")})),retVal},timeToString:function(timestamp){return new Date(1e3*timestamp).format("yyyy/MM/dd hh:mm")}}}},{}],35:[function(require,module,exports){var app=require("angular").module("app",[require("./controller"),require("./service"),require("./directive"),require("./filter"),require("./app.route.js"),require("../../node_modules/angular-scroll"),require("angular-smart-table")]);app.run(function($rootScope,$state,$stateParams,$injector,utilitySrv){var config={mode:"prod"};"dev"===config.mode?$rootScope.service=$injector.get("testSrv"):$rootScope.service=$injector.get("rawdataSrv"),$rootScope.$state=$state,$rootScope.$stateParams=$stateParams,$rootScope.global={topic:""},$rootScope.timeRange={start:function(d){return d.setDate(d.getDate()-7),d.setHours(0,0,0,0)}(new Date),end:function(d){return d.setDate(d.getDate()-1),d.setHours(0,0,0,0)}(new Date)},$rootScope.dateList=utilitySrv.getTimeRange($rootScope.timeRange.start,$rootScope.timeRange.end),window.history&&history.replaceState&&($rootScope.$on("duScrollspy:becameActive",function($event,$element,$target){var color=$element.find("div").attr("set-color");$($element.find("div")).addClass(color);for(var siblings=$element.parent().siblings(),labels=$(siblings).find("div.ui.label"),i=0;i<labels.length;i++){var e=$(labels.get(i));e.removeClass(e.attr("set-color"))}var hash=$element.prop("hash");hash&&history.replaceState(null,null,hash)}),$rootScope.popSubWin=function(params){$rootScope.$broadcast("start-get-data-in-window",params),$(".fullscreen.modal").find("div.echart").map(function(){echarts.getInstanceByDom(this).clear()}),$(".fullscreen.modal").modal("show")},$rootScope.init=function(){$(".fullscreen.modal").modal({observeChanges:!0,onVisible:function(e){$(this).find(".echart").map(function(i){echarts.getInstanceByDom(this).resize()})},onHidden:function(){$(this).find(".echart").map(function(i){echarts.getInstanceByDom(this).clear()})}})},$rootScope.init())})},{"../../node_modules/angular-scroll":4,"./app.route.js":11,"./controller":13,"./directive":23,"./filter":32,"./service":33,angular:9,"angular-smart-table":6}]},{},[35]);